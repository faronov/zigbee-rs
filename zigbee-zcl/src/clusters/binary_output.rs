...
pub struct BinaryOutputCluster {
    store: AttributeStore<10>,
}

impl Default for BinaryOutputCluster {
    fn default() -> Self {
        Self::new()
    }
}

impl BinaryOutputCluster {
    pub fn new() -> Self {
...
impl Cluster for BinaryOutputCluster {
    fn cluster_id(&self) -> ClusterId {
        ClusterId::BINARY_OUTPUT
    }
    fn handle_command(
        &mut self,
        _cmd_id: CommandId,
