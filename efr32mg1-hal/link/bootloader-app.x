/* EFR32MG1 Gecko-bootloader application linker script.
 *
 * Based on cortex-m-rt 0.7.5 link.x. The core exception vectors are emitted
 * here because Silicon Labs reserves vector word 13 for APP_PROPERTIES.
 */
...
SECTIONS
{
  ...
  .vector_table ORIGIN(FLASH) :
  {
    ...
    /* Core exceptions. Vector word 13 is Silicon Labs APP_PROPERTIES. */
