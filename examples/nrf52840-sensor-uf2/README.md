...
| board | linked bytes before UF2 | former regression budget |
|---|---:|---:|
...
The artificial budgets are no longer enforced. Physical application,
bootloader, security-journal, RAM, and stack boundaries remain mandatory.
