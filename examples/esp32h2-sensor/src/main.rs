...
//!
//! A complete no_std firmware for the ESP32-H2, implementing a Zigbee 3.0
//! end device with simulated temperature/humidity and a join/leave button.
//!
//! ## Hardware
//! - ESP32-H2 (RISC-V, built-in IEEE 802.15.4 + BLE 5 radio)
...
fn main() -> ! {
    ...
    esp_println::println!("[init] ESP32-H2 Zigbee sensor starting");
