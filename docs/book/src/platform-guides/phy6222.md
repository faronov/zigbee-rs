...
- **Ultra low cost** — modules available for ~$1.50 (TB-03F)
...
|-------|-------------|----------|--------|
| **Ai-Thinker TB-03F** | Module, castellated | P11 (R), P12 (G), P14 (B) | P15 (PROG) |
...
- **Ai-Thinker Flash Tool** — GUI tool for TB-03F modules
...
async fn main(_spawner: Spawner) {
    // Initialize GPIO for LEDs (TB-03F: active low)
