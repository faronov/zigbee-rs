...
SECTIONS
{
  ...
  . = ALIGN(32);
  __veneer_limit = .;
  PROVIDE(__xip_occupied_start = __stext);
  PROVIDE(__xip_occupied_end = __veneer_limit);
...
ASSERT(__xip_occupied_end - __xip_occupied_start <= 0x1ff00,
       "PHY62x2 XIP image exceeds the 130816-byte application slot");
