//! Deployment-selected nRF52840 security journal for UF2 images.
...
use crate::deployment::SELECTED;

pub const SECURITY_PARTITION_START: u32 = SELECTED.security_start;
...
const _: () = assert!(
    SECURITY_PARTITION_START as usize + SECURITY_PARTITION_SIZE == SELECTED.security_end as usize
);
const _: () = assert!(SELECTED.is_valid());
